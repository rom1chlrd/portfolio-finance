...
with tab_about:
    ...
    with col2:
        ...
        st.markdown("""
        **2026 (Jan-Mai)** 🇺🇸 **University of Florida**/n*Finance de Marché & Supply Chain*
        
        **2024 - Présent** 🇫🇷 **Junia HEI, Lille**/n*École d'ingénieur option Finance* *(Maths, VBA, Python)*

        **2022 - 2024** 🇫🇷 **Prépa Lycée LaSalle, Lille**/n*MPSI/MP*
