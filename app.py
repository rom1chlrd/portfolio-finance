...
tab_about, tab_tech, tab_mc, tab_market, tab_sales, tab_skills, tab_extra = st.tabs(["👤 À Propos", "💻 Pricer Options", "🎲 Monte Carlo", "📊 Market Data", "📢 Sales Pitch", "💼 Compétences", "🌍 Extra & Perso"])
